...
<?php
   ...
   $denied = null;
	...
	$new_notification = array("sender_id" =>"{$_SESSION["sender_id"]}", 
...
<?php include("header.php");?>	   
	 ...
	 ?>
		...
		<p style="text-align: right; margin-top: 2em; border-top: 1px solid #000000;" >Login as: <?php echo ucwords($_SESSION["current_member_name"]);?></p>
			...
			<ul class="form">
			<form action="send_notification.php?sender_id=<?php echo urlencode($_SESSION["current_member_id"]);?>&page=<?php echo urlencode($_SESSION["current_page"]);?>" method="post">
		   ...
		   <p><a href="notifications.php?member=<?php echo urlencode($_SESSION["current_member_id"]);?>&page=<?php echo urlencode($_SESSION["current_page"]);?>" style="color:green;">Cancel</a></p>
