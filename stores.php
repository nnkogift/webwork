...
?>
     <p><?php echo ucwords(htmlentities($name));?>&nbsp;<a href="stores.php?member=<?php echo urlencode($_SESSION["current_member_id"]);?>&page=<?php echo urlencode($_SESSION["current_page"]);?>&file=<?php echo urlencode($download["name"]);?>&id=<?php echo urlencode($download["id"]);?>"><?php echo $download["name"]; ?></a></p>
   <?php 
	} 
	?>
  </ul>
